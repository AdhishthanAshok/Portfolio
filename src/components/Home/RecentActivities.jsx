                    ...
                    <tbody>
                        <tr className="border-b-2">
                            ...
                            <td className="py-2 px-4  border-b-2 border-gray-700 dark:border-gray-400">
                                <a href="https://drive.google.com/file/d/1vOiAuzf1cjIsuejtULYPw86dBrkDcwrr/view" className="text-indigo-600 dark:text-green-600 underline" target="_blank"><b>Link</b></a>
                            </td>
                        </tr>
