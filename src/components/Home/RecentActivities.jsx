                    ...
                    <tbody>
                        <tr className="border-b-2">
                            <td className="py-2 px-4 text-gray-900 dark:text-white border-b-2 border-r-2 border-gray-700 dark:border-gray-400">
                                Review paper on <span className="font-bold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text animated-gradient-text">“Decentralized File Sharing System using Blockchain”</span> was accepted for <span className="font-bold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text animated-gradient-text">2025 4th OPJU International Technology Conference (OTCON), IEEE Xplore publication</span>.
                            </td>
                            <td className="py-2 px-4  border-b-2 border-gray-700 dark:border-gray-400">
                                <a href="https://drive.google.com/file/d/1vOiAuzf1cjIsuejtULYPw86dBrkDcwrr/view" className="text-indigo-600 underline" target="_blank"><b>Link</b></a>
                            </td>
                        </tr>
